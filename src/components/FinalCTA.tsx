  ...
  return (
    <div className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-neon-cyan/5 to-transparent">
      <div className="max-w-4xl mx-auto">
        <div className="glass rounded-2xl p-12 border border-neon-cyan/20 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <a
              href="#join"
              className="px-8 py-4 bg-gradient-to-r from-neon-cyan to-neon-purple text-black font-bold rounded-lg hover:shadow-lg hover:shadow-neon-cyan/50 transition-all duration-300"
            >
              Get Early Access
            </a>
            <a
              href="/about"
              className="px-8 py-4 glass border border-neon-cyan/30 text-neon-cyan font-bold rounded-lg hover:bg-white/10 transition-all duration-300"
            >
              Learn More
            </a>
          </div>
