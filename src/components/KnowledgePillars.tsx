...
export default function KnowledgePillars() {
  return (
    <div className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-neon-purple/5 to-transparent">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {knowledgePillars.map((pillar) => (
            ...
            >
              ...
              <h3 className="font-bold text-white mb-2 group-hover:text-neon-cyan transition-colors">
                {pillar.title}
              </h3>
